const API_KEY = "8612bc9faa608b9e50a9b88185e7597c";
...
function mapConditionToIcon(conditionText) {
  ...
  if (text.includes("rain") || text.includes("drizzle"))
    return "fas fa-cloud-rain text-cyan-200";
...
function renderForecast(data) {
  ...
  dailyForecasts.slice(1, 6).forEach((dayData) => {
    ...
    card.className = `
bg-white/10 backdrop-blur-xl border border-pink-200/20 
rounded-3xl p-5 text-center shadow-lg
hover:scale-105 hover:shadow-[0_0_30px_rgba(255,105,180,0.4)]
